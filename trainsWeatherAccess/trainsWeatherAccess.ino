...
//AP definitions, only if not using wifimanager
#define AP_SSID "ssid"
...
#define CONFIG_FILE "/trainsWeatherConfig.txt"
...
void setup() {
	...
	//http.begin(dataURL[0], dataFingerprint[0]);
	//http.addHeader("Content-Type", "text/xml");
